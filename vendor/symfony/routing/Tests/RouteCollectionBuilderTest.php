...
class RouteCollectionBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFlushSetsPrefixedWithMultipleLevels()
    {
        ...
        $adminRoutes->add('/admin', 'AdminController::userAction', 'admin_users');
        ...
        $this->assertEquals('/admin/admin', $collection->get('admin_users')->getPath(), 'Routes after mounting have the prefix');
