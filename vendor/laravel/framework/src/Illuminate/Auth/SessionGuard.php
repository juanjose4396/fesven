...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function attempt(array $credentials = [], $remember = false, $login = true)
    {
        ...
        // fact valid we'll log the admin into the application and return true.
    ...
    public function login(AuthenticatableContract $user, $remember = false)
    {
        ...
        // identifier. We will then decrypt this later to retrieve the admin.
        if ($remember) {
    ...
    public function logout()
    {
        ...
        // Once we have fired the logout event we will clear the admin out of memory
