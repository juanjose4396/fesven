...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><img src="{{asset('isotipo.png')}}" class="img-responsive" alt="User Image" /></span>
        <!-- logo for regular state and mobile devices -->
        <span class="col-md-9"><img src="{{asset('4.png')}}" class="img-responsive" alt="User Image" /> </span>
    </a>
    ...
    <!-- Logo -->
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                @if (Auth::guest())
                    <li><a href="{{route('admin') }}">{{ trans('adminlte_lang::message.register') }}</a></li>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{asset($dire)}}" class="user-image" alt="User Image"/>
